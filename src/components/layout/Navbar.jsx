...
function Navbar() {
  ...
  const [showPromo, setShowPromo] = useState(
    localStorage.getItem("cushite_promo_dismissed") !== "true"
  );

  const dismissPromo = () => {
    setShowPromo(false);
    localStorage.setItem("cushite_promo_dismissed", "true");
  };
      ...
      <AnimatePresence>
        {showPromo && (
          <motion.div
            ...
            className="relative overflow-hidden bg-[#4A136C] py-1.5 text-center text-xs text-white"
          >
